...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      <NavLink className="btn px-3 text-[16px] text-[#ff2a00] bg-transparent border-none" to="/">
        Home
      </NavLink>
      <NavLink className="btn px-3 text-[16px] ml-2 bg-transparent border-none" to="/all-services">
        All Services
      </NavLink>
      {user ? (
        ...
        <Link to="/sign-up">
          <button className="btn px-3 text-[16px] ml-2 bg-transparent border-none">Sign Up</button>
        </Link>
      )}
    </>
  );
          ...
          <div>
            {user ? (
              <button
                ...
                className="btn text-[18px] bg-[#ff2a00] hover:bg-[#ff2a00] text-white border-none ml-2"
              >
                Log Out
              </button>
            ) : (
              <Link to="/login">
                <button className="btn text-[18px] bg-[#ff2a00] hover:bg-[#ff2a00] text-white border-none  ml-2">
                  Login
                </button>
              </Link>
            )}
